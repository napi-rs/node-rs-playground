...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn(
      'tw--mx-1 tw-my-1 tw-h-px tw-bg-zinc-100 dark:tw-bg-zinc-800',
      className
    )}
    {...props}
  />
